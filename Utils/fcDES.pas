...
type
  DES = record
    class function EncryStr(Str, Key: String): String; static; // 返回UTF8格式
    class function DecryStr(Str, Key: String): String; static;

    // 用这2个函数，返回是HEX格式，比较好存储
    class function EncryStrHex(Str, Key: String): String; static;
    class function DecryStrHex(StrHex, Key: String): String; static;
...
class function DES.EncryStr(Str, Key: String): String;
var
...
class function DES.DecryStr(Str, Key: String): String;
var
  StrByte, OutByte, KeyByte: array [0 .. 7] of Byte;
  StrResult: String;
  i, j: Integer;
...
class function DES.EncryStrHex(Str, Key: String): String;
var
...
class function DES.DecryStrHex(StrHex, Key: String): String;
